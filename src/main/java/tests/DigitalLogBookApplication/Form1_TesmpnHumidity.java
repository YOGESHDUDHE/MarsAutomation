...
public class Form1_TesmpnHumidity extends BaseExecutor {
	...
	public void storeSelection() throws InterruptedException {
		...
		//Temperature & Humidity Form
		testlog.log(clickOnElement("xpath",DigitalLogbook.tempnHumidity.tempnHumidityBttn), "Click on Temperature&Humidity Form");
		
		// Shift
		Thread.sleep(1000);
		testlog.log(test.clickListboxvalue(DigitalLogbook.tempnHumidity.shift, "MID"), "Shift Selected - Mid");
		
		// Temperature
		testlog.log(enterValues("xpath",DigitalLogbook.tempnHumidity.temperature,"50"), "Entered temperature value- 50");
		
		// Humidity
		testlog.log(enterValues("xpath",DigitalLogbook.tempnHumidity.humidity,"50"), "Entered Humidity value- 50");
		
		// Comments
		testlog.log(enterValues("xpath",DigitalLogbook.tempnHumidity.comments,"Selenium test"), "Entered comments");
		
		// Save & Submit
		Thread.sleep(2000);
		testlog.log(clickOnElement("xpath",DigitalLogbook.tempnHumidity.savenSubmit), "Clicked on Save&Submit");
	}
